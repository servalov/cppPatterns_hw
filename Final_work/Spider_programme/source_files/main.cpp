...
int main()
{
	...
	try
	{
		...
		std::cout << "\n Начало работы поискового робота Spider ..." << std::endl;


		Spider spider(ini_data);

		std::cout << " Для начала работы поискового робота Spider нажмите Enter...";
		std::cin.get();
	...
	{
		std::cerr << "\n   Программа завершает работу из-за ошибки !!!" << std::endl;
		return 1; 
	}
